...
public class TC_SystemSettings_TemperatureTest extends TC_LoginTest_DDT_001 {
	...
	public void Test_Celsius_SysDefaultSettings() throws Exception {
	...
	public void Test_Farnheit_SysDefaultSettings() throws Exception {
	...
	@Test(priority = 3,enabled=true, dataProvider = "OTTValues_Celsius", dataProviderClass = com.nordson.utilities.XLUtils.class)
	...
	public void Test_Celsius_OTT_Syssettings(String minlssval, String maxplusval, String Inrngval)
		...
		System.out.println("toastmsg for min-1 value is "+tststusminerr);
		softAssert.assertEquals(tststusminerr,Constants.OTTErrmsg,"Toast error message is shown up for for celsius unit min-1 value");
		log.info("Toast error message is shown up for OTTemp min val for celsius unit");

		boolean stusminerr = Tss.getSavebtnstatus();
		softAssert.assertEquals( stusminerr,true,"Error message is shown up for for celsius unit min-1 value");
		...
		softAssert.assertEquals(tststusmaxerr,Constants.OTTErrmsg,
				"Toast error message is shown up for OTTemp max val for celsius unit max+1 value");
		log.info("Toast error message is shown up for max val for celsius unit");

		boolean stusmaxerr = Tss.getSavebtnstatus();
		softAssert.assertEquals(stusmaxerr,true,"Error message is shown up for OTTemp max val for celsius unit max+1 value");
		...
		softAssert.assertEquals( tststus,Constants.Sucssmsg,
				"Toast msg for In range values are saved successfully for OTTemp for celsius unit inrng value");
		log.info("Toast msg for In range values are saved successfully for celsius unit");
		
		boolean stusinrngmsg = Tss.getSavebtnstatus();
		softAssert.assertEquals(stusinrngmsg,false,"Error message is shown up for OTTemp max val for celsius unit inrng value");
		log.info("Error message is shown up for max val for celsius unit");
	  ...
	  public void Test_Celsius_Tofarnhit_Conversion_OTTfield() throws
	  Exception {
	  Tss.clickPreferencesBtn(); 
	  Thread.sleep(2000);
	  Tss.clickFarhenitUnit(); 
	  ...
	  Tss.clickSave();
	  if(Tss.getToastmsgststus()==true)
	  log.info("Prefrences updated sucessfully"); else
	  log.info("Prefrences not updated sucessfully");
	  ...
	  softAssert.assertEquals(cvtfh, OTTtemp,
	  "Celsius to Farnhit unit conversion not correct");
	  ...
	  @Test(priority = 5, enabled=true,dataProvider = "OTTValues_Farnheit",
	  dataProviderClass = com.nordson.utilities.XLUtils.class)
	  
	  @Description("Verify the boundary Values for farnheit Temperature Unit of OTT field"
	  ) public void Test_Farnhit_OTT_Syssettings(String minlssvalfh, String
	  maxplusvalfh, String Inrngvalfh) throws Exception {
	  ...
	  softAssert.assertEquals(tststusclrerrmsgfh,Constants.OTTErrmsgFH,
	  "Toast error message is shown up for max OTTemp val for Farhnit unit"); log.
	  info("Toast error message is shown up for null OTTemp val save for Farhnit");
	  
	  boolean stusclrerrmsgfh = Tss.getSavebtnstatus();
	  softAssert.assertEquals(true, stusclrerrmsgfh,
	  "Error message is shown up for max OTTemp val for Farhnit unit");
	  ...
	  softAssert.assertEquals( tststusminerrfh,Constants.OTTErrmsgFH,
	  "Toast error message is shown up for Farhnit unit");
	  log.info("Toast error message is shown up for OTTemp min val Farhnit unit");
	  
	  boolean stusminerrfh = Tss.getSavebtnstatus(); softAssert.assertEquals(true,
	  stusminerrfh, "Error message is shown up for Farhnit unit");
	  ...
	  softAssert.assertEquals(tststusmaxerrfh,Constants.OTTErrmsgFH,
	  ...
	  stusmaxerrfh, "Error message is shown up for OTTemp max val Farhnit unit");
	  ...
	  softAssert.assertEquals( tststusfh,Constants.Sucssmsg,
	  "Toastmsg for In range values are saved successfully for OTTemp Farhnit unit"
	  ); log.
	  info("Toast msg for In range values are saved successfully for Farhnit unit"
	  );
	  
	  boolean stusfh = Tss.getSavebtnstatus();
	  softAssert.assertEquals(false,
	  stusfh, "In range values are saved successfully for OTTemp Farhnit unit");
	  ...
	  ) public void Test_Farnhit_ToCelsius_Conversion_OTTfield() throws
	  Exception {
	  
	  Tss.clickPreferencesBtn(); Thread.sleep(2000);
	  
	  Tss.clickCelsiusUnit(); log.
	  info("Temperature Unit Celsius is selected by clicking to verfiy conversion"
	  );
	  
	  Tss.clickSave(); log.info("Saved Celsius Option to verfiy conversion");
	  
	  
	  if(Tss.getToastmsgststus()==true) log.info("Prefrences updated sucessfully");
	  else log.info("Prefrences not updated sucessfully");
	  
	  
	  
	  Tss.clickTemperatureBtn(); log.
	  info("Clicked on Temperature in System settings button to validate OTT farhenit to celsius conversion"
	  );
	  
	  String fhtocelsius = ActionMethods.getConversionToCelsiusSys(OTTtempfarnh);
	  String OTTtemp = Tss.getOTTemperature(); softAssert.assertEquals(OTTtemp,
	  fhtocelsius, "Farnhit to Celsius unit conversion not correct");
	  log.info("Farnhit to Celsius unit conversion for OTT is correct");
	  
	  XLUtils.setExcelSheetNm("UTTCelsius"); softAssert.assertAll();
	  
	  }
	  
	  @Test(priority = 7,enabled=true, dataProvider = "UTTValues_Celsius",
	  dataProviderClass = com.nordson.utilities.XLUtils.class)
	  ...
	  ) public void Test_Celsius_SysMinmaxForUTT(String minlssval, String
	  maxplusval, String Inrngval) throws Exception {
	  ...
	  log.
	  info("Toast error message is shown up for null UTTemp val for Celsius unit after save"
	  );
	  
	  boolean stusclrerrmsg = Tss.getSavebtnstatus(); softAssert.assertEquals(true,
	  stusclrerrmsg, "Error message is not shown up for max UTTemp Celsius val");
	  log.
	  info("Error message is shown up for null UTTemp val for Celsius unit after save"
	  );
	  ...
	  "Toast error message is not shown up for UTTemp Celsius unit"); log.
	  info("Toast error message is shown up for min UTTemp val for Celsius unit");
	  ...
	  boolean stusmaxerr = Tss.getSavebtnstatus(); softAssert.assertEquals(true,
	  stusmaxerr, "Error message is not shown up for Celsius unit max val");
	  ...
	  info("Toast msg for In range values are saved successfully for UTTemp Celsius unit"
	  );
	  
	  boolean stus = Tss.getSavebtnstatus(); softAssert.assertEquals(false, stus,
	  "In range values are not saved successfully for UTTemp Celsius unit");
	  ...
	  ) public void Test_Celsius_Tofarnhit_Conversion_UTTfield() throws
	  Exception {
	  ...
	  if (Tss.getToastmsgststus()==true)
	  log.info("Preferences are sucessfully updated"); else
	  log.info("Preferences are not sucessfully updated");
	  
	  Tss.clickTemperatureBtn(); log.
	  info("Clicked on Temperature in System settings button to validate UTT Celsius to farhenit conversion"
	  );
	  
	  String cvtfh = ActionMethods.getConversionToFahrenheitSys(UTTtempcsl); String
	  UTTtemp = Tss.getUTTemperature(); softAssert.assertEquals(UTTtemp, cvtfh,
	  "Celsius to Farnhit unit conversion not correct");
	  log.info("Celsius to Farnhit unit conversion for UTT is correct");
	  
	  XLUtils.setExcelSheetNm("UTTFarnhit"); softAssert.assertAll();
	  
	  }
	  
	  @Test(priority = 9,enabled=true, dataProvider = "UTTValues_Farnheit",
	  dataProviderClass = com.nordson.utilities.XLUtils.class)
	  
	  @Description("Verify the boundary Values for farnheit Temperature Unit of UTT field"
	  ) public void Test_Farnhit_SysMinmaxForUTT(String minlssvalfh, String
	  maxplusvalfh, String Inrngvalfh) throws Exception {
	  ...
	  "Toast error message is not shown up for max UTTemp Farhenit val"); log.
	  info("Toast error message is shown up for null UTTemp val for Farhenit unit after save"
	  );
	  
	  boolean stusclrerrmsgfh = Tss.getSavebtnstatus();
	  softAssert.assertEquals(true, stusclrerrmsgfh,
	  "Error message is not shown up for max UTTemp Farhenit val"); log.
	  info("Error message is shown up for null UTTemp val for Farhenit unit after save"
	  );
	  ...
	  "Toast error message is not shown up for UTTemp Farhenit unit"); log.
	  info("Toast error message is shown up for min UTTemp val for Farhenit unit");
	  
	  boolean stusminerrfh = Tss.getSavebtnstatus(); softAssert.assertEquals(true,
	  stusminerrfh, "Error message is not shown up for UTTemp Farhenit unit");
	  ...
	  boolean stusmaxerrfh = Tss.getSavebtnstatus(); softAssert.assertEquals(true,
	  stusmaxerrfh, "Error message is not shown up for Farhenit unit max val");
	  ...
	  info("Toast msg In range values are saved successfully for UTTemp Farhenit unit"
	  );
	  
	  boolean stusfh = Tss.getSavebtnstatus(); softAssert.assertEquals(false,
	  stusfh,
	  "In range values are not saved successfully for UTTemp Farhenit unit");
	  ...
	  ) public void Test_Farnhit_ToCelsius_Conversion_UTTfield() throws
	  Exception {
	  ...
	  String UTTtemp = Tss.getUTTemperature(); softAssert.assertEquals(UTTtemp,
	  fhtocelsius, "Farnhit to Celsius unit conversion not correct");
	  log.info("Farnhit to Celsius unit conversion for OTT is correct");
	  
	  XLUtils.setExcelSheetNm("TempsetbckCelsius"); softAssert.assertAll();
	  
	  }
	  
	  @Test(priority = 11,enabled=true, dataProvider = "TempstbckValues_Celsius",
	  dataProviderClass = com.nordson.utilities.XLUtils.class)
	  ...
	  ) public void Test_Celsius_SysMinmaxForTmpstbck(String minlssval, String
	  maxplusval, String Inrngval) throws Exception {
	  ...
	  info("Toast error message is shown up for null Tempsetbck val save celsuis unit"
	  );
	  ...
	  log.
	  info("Error message is shown up for null Tempsetbck val save celsuis unit");
	  ...
	  "Toast error message is not shown up for Tempsetbck celsuis unit"); log.
	  info("Toast error message is shown up for min Tempsetbck val celsuis unit");
	  
	  boolean stusminerr = Tss.getSavebtnstatus(); softAssert.assertEquals(true,
	  stusminerr, "Error message is not shown up for Tempsetbck celsuis unit");
	  ...
	  log.
	  info("Toast error message is shown up for max Tempsetbck val celsuis unit");
	  
	  boolean stusmaxerr = Tss.getSavebtnstatus(); softAssert.assertEquals(true,
	  stusmaxerr,
	  "Error message is not shown up for max Tempsetbck val celsuis unit ");
	  ...
	  info("Toast msg for In range values are saved successfully for Tempsetbck celsuis unit"
	  );
	  
	  boolean stus = Tss.getSavebtnstatus(); softAssert.assertEquals(false, stus,
	  "In range values are not saved successfully for Tempsetbck celsuis unit");
	  ...
	  ) public void Test_Celsius_Tofarnhit_Conversion_Tempstbck() throws
	  Exception {
	  
	  Thread.sleep(1500); Tss.clickPreferencesBtn(); Thread.sleep(1200);
	  
	  Tss.clickFarhenitUnit(); log.
	  info("Temperature Unit Farhenit is selected by clicking to verfiy conversion"
	  );
	  ...
	  Tss.clickTemperatureBtn(); log.
	  info("Clicked on Temperature in System settings button to validate OTT Celsius to farhenit conversion"
	  );
	  
	  String cvtfh = ActionMethods.getConversionToFahrenheitSys(tmpstbckcsl);
	  String OTTtemp = Tss.getOTTemperature(); softAssert.assertEquals(OTTtemp,
	  cvtfh, "Celsius to Farnhit unit conversion not correct");
	  log.info("Celsius to Farnhit unit conversion for OTT is correct");
	  
	  XLUtils.setExcelSheetNm("TempsetbckFarnhit"); softAssert.assertAll();
	  
	  }
	  
	  @Test(priority = 13, enabled=true,dataProvider = "TempstbckValues_Farnheit",
	  dataProviderClass = com.nordson.utilities.XLUtils.class)
	  
	  @Description("Verification of boundary Values for farnheit Temperature Unit of temperature set back field"
	  ) public void Test_Farnhit_SysMinmaxForTmpstbck(String minlssvalfh, String
	  maxplusvalfh, String Inrngvalfh) throws Exception {
	  ...
	  log.
	  info("Error message is shown up for null Tempsetbck val save farhenit unit");
	  ...
	  "Toast error message is not shown up for Tempsetbck farhenit unit"); log.
	  info("Toast error message is shown up for min Tempsetbck val celsuis unit");
	  
	  boolean stusminerrfh = Tss.getSavebtnstatus(); softAssert.assertEquals(true,
	  stusminerrfh, "Error message is not shown up for Tempsetbck farhenit unit");
	  log.info("Error message is shown up for min Tempsetbck val celsuis unit");
	  ...
	  info("Toast msg for In range values are saved successfully for Tempsetbck farhenit unit"
	  );
	  ...
	  log.
	  info("In range values are saved successfully for Tempsetbck farhenit unit");
	  ...
	  ) public void Test_Farnhit_ToCelsius_Conversion_Tempstbck() throws
	  Exception {
	  ...
	  Tss.clickTemperatureBtn(); log.info(
	  ...
	  softAssert.assertEquals(tmpstbck, fhtocelsius,
	  "Farnhit to Celsius unit conversion not correct for tmpstbck");
