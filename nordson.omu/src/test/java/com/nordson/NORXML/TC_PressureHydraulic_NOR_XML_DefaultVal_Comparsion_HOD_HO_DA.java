...
public class TC_PressureHydraulic_NOR_XML_DefaultVal_Comparsion_HOD_HO_DA extends TC_LoginTest_DDT_001 {
	...
	public void sheetname() {
		XLUtils.setExceltNm("NorfilePressure_Hydraulic_Default_HOD_HO_DA");
	}
	...
	public void TC_Hydraulic_HOD_HO_DA_Manualadjust_Default_KPA_Pressure_Value_NorFileValue_comparision_with_UI()
		...
		softAssert.assertEquals(pressminVal,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval
				.XMLParser(XMLTagConstants.MinimumPressureAlertNative),Constants.HOD_HO_DA));
		...
		//Verification of ulHighPressureAlertThresholdNative tag with Pressure Unit as -KPA
				String newcnvval=String.valueOf(Integer.parseInt(Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval
						.XMLParser(XMLTagConstants.MaximumPressureAlertNative),Constants.HOD_HO_DA))+8).toString();
	...
	@Test(priority = 2, enabled = false)
	 public void TC_Hydraulic_HOD_HO_DA_Manualadjust_Default_BAR_Pressure_Value_NorFileValue_comparision_with_UI()
		...
		double val1=Precision.round(Double.parseDouble(Am.conversion_of_BAR_NOR_vlaue_TO_UI_Hydraulic(xmlval
				.XMLParser(XMLTagConstants.MaximumPressureAlertNative),Constants.HOD_HO_DA)),2);
	...
	public void TC_Hydraulic_HOD_HO_DA_Manualadjust_Default_PSI_Pressure_Value_NorFileValue_comparision_with_UI()
		...
		softAssert.assertEquals(pressmaxVal,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval
				.XMLParser(XMLTagConstants.MaximumPressureAlertNative),Constants.HOD_HO_DA));
		softAssert.assertAll();
	}
	...
	//Verification of ulPressureSetPointNative tag with Pressure Unit as -KPA
		softAssert.assertEquals(prspnt,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.PressureSetpointNative)),Constants.HOD_HO_DA));
	//Verification of ulLowPressureAlertDeltaNative tag with Pressure Unit as -KPA
		softAssert.assertEquals(lwprsthrshld,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.LowPressureAlertthsldelctrnicNative)),Constants.HOD_HO_DA));
		...
		softAssert.assertEquals(hghprsthrshld,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.highPressureAlertthsldelctrnicNative)),Constants.HOD_HO_DA));
		...
		softAssert.assertEquals(minprsstpntrng,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.MinimumPressureSetpointrangeNative)),Constants.HOD_HO_DA));
		...
		softAssert.assertEquals(maxprsstpntrng,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.MaximumPressureSetpointrangeNative)),Constants.HOD_HO_DA));
        softAssert.assertAll();
	}
	...
	public void TC_Hydraulic_HOD_HO_DA_RunUP_NorFileValue_comparision_with_UI_KPA()
		...
		softAssert.assertEquals(lwspdprssttng,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.LowSppdPressuresetting),Constants.HOD_HO_DA));
		//Verification of usPressureCalPtMax tag with Pressure Unit as -KPA
		softAssert.assertEquals(hghspdprsstng,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.HighSppdPressuresetting),Constants.HOD_HO_DA));
		//Verification of usPressureMax tag with Pressure Unit as -KPA
		softAssert.assertEquals(setmaxprsslmt,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetmaxPressurelimit),Constants.HOD_HO_DA));
		//Verification of usPressureMin tag with Pressure Unit as -KPA
		softAssert.assertEquals(setminprsslmt,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetminPressurelimit),Constants.HOD_HO_DA));
		softAssert.assertAll();
	}
	...
	public void TC_Hydraulic_HOD_HO_DA_RunUP_NorFileValue_comparision_with_UI_BAR()
		...
		softAssert.assertEquals(setmaxprsslmt,Am.conversion_of_BAR_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetmaxPressurelimit),Constants.HOD_HO_DA));
		//Verification of usPressureMin tag with Pressure Unit as -BAR
		 if(setminprsslmt.contains(Am.conversion_of_BAR_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetminPressurelimit),Constants.HOD_HO_DA)))
	...
	public void TC_Hydraulic_HOD_HO_DA_RunUP_NorFileValue_comparision_with_UI_PSI()
		...
		softAssert.assertEquals(lwspdprssttng,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.LowSppdPressuresetting),Constants.HOD_HO_DA));
		//Verification of usPressureCalPtMax tag with Pressure Unit as -PSI
		softAssert.assertEquals(hghspdprsstng,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.HighSppdPressuresetting),Constants.HOD_HO_DA));
		//Verification of usPressureMax tag with Pressure Unit as -PSI
		softAssert.assertEquals(setmaxprsslmt,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetmaxPressurelimit),Constants.HOD_HO_DA));
		//Verification of usPressureMin tag with Pressure Unit as -PSI
		softAssert.assertEquals(setminprsslmt,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetminPressurelimit),Constants.HOD_HO_DA));
		softAssert.assertAll();
	}
