...
public class TC_NORFile_Download_min_press_And_max_Press_KPA extends TC_LoginTest_DDT_001 {
	...
	XMLClass xmlval=new XMLClass();
	 ...
	 @Test(priority=0,enabled = true) public void sheetname() {
		  XLUtils.setExcelSheetNm("MinPress_KPA"); 
		  }
	 
	 
	
	@Test(priority = 1, enabled = true,dataProvider ="min_Presure_for_norfile_KPA",dataProviderClass = com.nordson.utilities.XLUtils.class)
	public void Min_KPA_Press_Value_comparision_with_NorFile(String Min) throws InterruptedException, IOException, SAXException  {
		  ...
		  rsp.SelectKPAUnit(); 
		    ...
		    softAssert.assertEquals(false,rsp.saveButtonEnabled());
			 ...
			 // String newfilename=Am.removeSpaces(flnm);
			  ...
			  XLUtils.setminPressurevalueKPA(xmlval.XMLParser(XMLTagConstants.
			  ...
			  XLUtils.setExcelSheetNm("MaxPress_KPA");	  
	}
	@Test(priority = 2, enabled = true,dataProvider ="max_Presure_for_norfile_KPA",dataProviderClass = com.nordson.utilities.XLUtils.class)
	public void Max_KPA_Press_Value_comparision_with_NorFile(String Max) throws InterruptedException, IOException, SAXException  {
		    ...
		    softAssert.assertEquals(false,rsp.saveButtonEnabled());
			 ...
			 // String newfilename=Am.removeSpaces(flnm);
			  ...
			  XLUtils.setmaxPressurevalueKPA(xmlval.XMLParser(XMLTagConstants.
