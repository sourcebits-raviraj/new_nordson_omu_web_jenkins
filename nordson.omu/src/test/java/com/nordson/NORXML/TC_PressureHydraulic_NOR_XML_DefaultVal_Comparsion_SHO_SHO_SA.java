...
public class TC_PressureHydraulic_NOR_XML_DefaultVal_Comparsion_SHO_SHO_SA extends TC_LoginTest_DDT_001 {
	...
	public void sheetname() {
		XLUtils.setExceltNm("NorfilePressure_Hydraulic_Default_SHO_SHO_SA");
	}
    
	@Feature("Pressure Scaling as Hydraulic with pump ratio as SHO SHO-SA and Pressure mode as Manual adjust")
	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert Default value in downloaded NOR file for KPA Unit for SHO SHO-SA pump ratio")
	@Test(priority = 1, enabled = true)
	public void TC_Hydraulic_SHO_SHO_SA_Manualadjust_Default_KPA_Pressure_Value_NorFileValue_comparision_with_UI()
			throws Exception {
		...
		softAssert.assertEquals(pressminVal,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval
				.XMLParser(XMLTagConstants.MinimumPressureAlertNative),Constants.SHO_SHO_SA));
		...
		String newcnvval=String.valueOf(Integer.parseInt(Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval
				.XMLParser(XMLTagConstants.MaximumPressureAlertNative),Constants.SHO_SHO_SA))+6).toString();
		softAssert.assertEquals(pressmaxVal,newcnvval);
        softAssert.assertAll();
	}

	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert value from downloaded NOR file to UI for BAR Unit SHO SHO-SA pump ratio")
	@Test(priority = 2, enabled = true)
	 public void TC_Hydraulic_SHO_SHO_SA_Manualadjust_Default_BAR_Pressure_Value_NorFileValue_comparision_with_UI()
			throws Exception {
		...
		//Verification of ulHighPressureAlertThresholdNative tag with Pressure Unit as -BAR
				double val1=Precision.round(Double.parseDouble(Am.conversion_of_BAR_NOR_vlaue_TO_UI_Hydraulic(xmlval
						.XMLParser(XMLTagConstants.MaximumPressureAlertNative),Constants.SHO_SHO_SA)),2);
				String newcnvval=String.valueOf(Precision.round(val1+0.06,2));
				System.out.println(newcnvval+"newcnvval"+pressmaxVal);
				softAssert.assertEquals(pressmaxVal,newcnvval);
				softAssert.assertAll();
	}
	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert value from downloaded NOR file to UI for PSI Unit SHO SHO-SA pump ratio")
	@Test(priority = 3, enabled = true)
	public void TC_Hydraulic_SHO_SHO_SA_Manualadjust_Default_PSI_Pressure_Value_NorFileValue_comparision_with_UI()
			throws Exception {
		...
		softAssert.assertEquals(pressmaxVal,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval
				.XMLParser(XMLTagConstants.MaximumPressureAlertNative),Constants.SHO_SHO_SA));
		softAssert.assertAll();
	}
	...
	public void TC_Hydraulic_SHO_SHO_SA_electronicadjust_NorFileValue_comparision_with_UI_KPA()
			throws Exception {
	...
	//Verification of ulPressureSetPointNative tag with Pressure Unit as -KPA
		softAssert.assertEquals(prspnt,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.PressureSetpointNative)),Constants.SHO_SHO_SA));
	//Verification of ulLowPressureAlertDeltaNative tag with Pressure Unit as -KPA
		softAssert.assertEquals(lwprsthrshld,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.LowPressureAlertthsldelctrnicNative)),Constants.SHO_SHO_SA));
		...
		softAssert.assertEquals(hghprsthrshld,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.highPressureAlertthsldelctrnicNative)),Constants.SHO_SHO_SA));
		...
		softAssert.assertEquals(minprsstpntrng,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.MinimumPressureSetpointrangeNative)),Constants.SHO_SHO_SA));
		...
		softAssert.assertEquals(maxprsstpntrng,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.MaximumPressureSetpointrangeNative)),Constants.SHO_SHO_SA));
        softAssert.assertAll();
	}
	...
	public void TC_Hydraulic_SHO_SHO_SA_electronicadjust_NorFileValue_comparision_with_UI_BAR()
			throws Exception {
	...
	public void TC_Hydraulic_SHO_SHO_SA_electronicadjust_NorFileValue_comparision_with_UI_PSI()
			throws Exception {
	...
	public void TC_Hydraulic_SHO_SHO_SA_RunUP_NorFileValue_comparision_with_UI_KPA()
			throws Exception {
		...
		softAssert.assertEquals(lwspdprssttng,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.LowSppdPressuresetting),Constants.SHO_SHO_SA));
		//Verification of usPressureCalPtMax tag with Pressure Unit as -KPA
		softAssert.assertEquals(hghspdprsstng,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.HighSppdPressuresetting),Constants.SHO_SHO_SA));
		//Verification of usPressureMax tag with Pressure Unit as -KPA
		softAssert.assertEquals(setmaxprsslmt,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetmaxPressurelimit),Constants.SHO_SHO_SA));
		//Verification of usPressureMin tag with Pressure Unit as -KPA
		softAssert.assertEquals(setminprsslmt,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetminPressurelimit),Constants.SHO_SHO_SA));
		softAssert.assertAll();
	}
	...
	public void TC_Hydraulic_SHO_SHO_SA_RunUP_NorFileValue_comparision_with_UI_BAR()
			throws Exception {
		...
		softAssert.assertEquals(lwspdprssttng,Am.conversion_of_BAR_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.LowSppdPressuresetting),Constants.SHO_SHO_SA));
		//Verification of usPressureCalPtMax tag with Pressure Unit as -BAR
		softAssert.assertEquals(hghspdprsstng,Am.conversion_of_BAR_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.HighSppdPressuresetting),Constants.SHO_SHO_SA));
		//Verification of usPressureMax tag with Pressure Unit as -BAR
		softAssert.assertEquals(setmaxprsslmt,Am.conversion_of_BAR_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetmaxPressurelimit),Constants.SHO_SHO_SA));
		//Verification of usPressureMin tag with Pressure Unit as -BAR
		 if(setminprsslmt.contains(Am.conversion_of_BAR_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetminPressurelimit),Constants.SHO_SHO_SA)))
	...
	public void TC_Hydraulic_SHO_SHO_SA_RunUP_NorFileValue_comparision_with_UI_PSI()
			throws Exception {
		...
		softAssert.assertEquals(lwspdprssttng,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.LowSppdPressuresetting),Constants.SHO_SHO_SA));
		//Verification of usPressureCalPtMax tag with Pressure Unit as -PSI
		softAssert.assertEquals(hghspdprsstng,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.HighSppdPressuresetting),Constants.SHO_SHO_SA));
		//Verification of usPressureMax tag with Pressure Unit as -PSI
		softAssert.assertEquals(setmaxprsslmt,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetmaxPressurelimit),Constants.SHO_SHO_SA));
		//Verification of usPressureMin tag with Pressure Unit as -PSI
		softAssert.assertEquals(setminprsslmt,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetminPressurelimit),Constants.SHO_SHO_SA));
		softAssert.assertAll();
	}
