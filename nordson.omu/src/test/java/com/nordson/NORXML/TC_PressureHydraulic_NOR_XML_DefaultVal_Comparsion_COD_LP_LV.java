...
public class TC_PressureHydraulic_NOR_XML_DefaultVal_Comparsion_COD_LP_LV extends TC_LoginTest_DDT_001 {
	...
	public void sheetname() {
		XLUtils.setExceltNm("NorfilePressure_Hydraulic_Default_COD_LP_LV");
	}
    
	@Feature("Pressure Scaling as Hydraulic with pump ratio as COD LP/LV and Pressure mode as Manual adjust")
	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert Default value in downloaded NOR file for KPA Unit for COD LP/LV pump ratio")
	@Test(priority = 1, enabled = true)
	public void TC_Hydraulic_COD_LP_LV_Manualadjust_Default_KPA_Pressure_Value_NorFileValue_comparision_with_UI()
			throws Exception {
		...
		log.info("Selected COD LP/LV Pump ratio for Hydraulic pressure scaling");
		...
		softAssert.assertEquals(pressminVal,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval
				.XMLParser(XMLTagConstants.MinimumPressureAlertNative),Constants.COD_LP_LV));
		...
		String newcnvval=String.valueOf(Integer.parseInt(Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval
				.XMLParser(XMLTagConstants.MaximumPressureAlertNative),Constants.COD_LP_LV))+3).toString();
		softAssert.assertEquals(pressmaxVal,newcnvval);
        softAssert.assertAll();
	}

	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert value from downloaded NOR file to UI for BAR Unit COD LP/LV pump ratio")
	@Test(priority = 2, enabled = true)
	 public void TC_Hydraulic_COD_LP_LV_Manualadjust_Default_BAR_Pressure_Value_NorFileValue_comparision_with_UI()
			throws Exception {
		...
		//Verification of ulHighPressureAlertThresholdNative tag with Pressure Unit as -BAR
				double val1=Precision.round(Double.parseDouble(Am.conversion_of_BAR_NOR_vlaue_TO_UI_Hydraulic(xmlval
						.XMLParser(XMLTagConstants.MaximumPressureAlertNative),Constants.COD_LP_LV)),2);
				String newcnvval=String.valueOf(Precision.round(val1+0.03,2));
				System.out.println(newcnvval+"newcnvval"+pressmaxVal);
				softAssert.assertEquals(pressmaxVal,newcnvval);
				softAssert.assertAll();
	}
	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert value from downloaded NOR file to UI for PSI Unit COD LP/LV pump ratio")
	@Test(priority = 3, enabled = true)
	public void TC_Hydraulic_COD_LP_LV_Manualadjust_Default_PSI_Pressure_Value_NorFileValue_comparision_with_UI()
			throws Exception {
		...
		softAssert.assertEquals(pressmaxVal,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval
				.XMLParser(XMLTagConstants.MaximumPressureAlertNative),Constants.COD_LP_LV));
		softAssert.assertAll();
	}
	
	@Feature("Pressure Scaling as Hydraulic with pump ratio as COD LP/LV and Pressure mode as Electronic adjust for COD LP/LV pump ratio")
	@Description("Verify the All fields with UI value in downloaded NOR file for KPA Unit")
	@Test(priority = 4, enabled = true)
	public void TC_Hydraulic_COD_LP_LV_electronicadjust_NorFileValue_comparision_with_UI_KPA()
			throws Exception {
	...
	//Verification of ulPressureSetPointNative tag with Pressure Unit as -KPA
		softAssert.assertEquals(prspnt,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.PressureSetpointNative)),Constants.COD_LP_LV));
	//Verification of ulLowPressureAlertDeltaNative tag with Pressure Unit as -KPA
		softAssert.assertEquals(lwprsthrshld,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.LowPressureAlertthsldelctrnicNative)),Constants.COD_LP_LV));
		...
		softAssert.assertEquals(hghprsthrshld,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.highPressureAlertthsldelctrnicNative)),Constants.COD_LP_LV));
		...
		softAssert.assertEquals(minprsstpntrng,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.MinimumPressureSetpointrangeNative)),Constants.COD_LP_LV));
		...
		softAssert.assertEquals(maxprsstpntrng,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic((xmlval
				.XMLParser(XMLTagConstants.MaximumPressureSetpointrangeNative)),Constants.COD_LP_LV));
        softAssert.assertAll();
	}
	...
	public void TC_Hydraulic_COD_LP_LV_electronicadjust_NorFileValue_comparision_with_UI_BAR()
			throws Exception {
	...
	public void TC_Hydraulic_COD_LP_LV_electronicadjust_NorFileValue_comparision_with_UI_PSI()
			throws Exception {
	...
	@Feature("Pressure Scaling as Hydraulic with pump ratio as COD LP/LV and Pressure mode as RunUP for COD LP/LV pump ratio")
	@Description("Verify the All fields with UI value in downloaded NOR file for KPA Unit")
	@Test(priority = 7, enabled = true)
	public void TC_Hydraulic_COD_LP_LV_RunUP_NorFileValue_comparision_with_UI_KPA()
			throws Exception {
		...
		softAssert.assertEquals(lwspdprssttng,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.LowSppdPressuresetting),Constants.COD_LP_LV));
		//Verification of usPressureCalPtMax tag with Pressure Unit as -KPA
		softAssert.assertEquals(hghspdprsstng,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.HighSppdPressuresetting),Constants.COD_LP_LV));
		//Verification of usPressureMax tag with Pressure Unit as -KPA
		softAssert.assertEquals(setmaxprsslmt,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetmaxPressurelimit),Constants.COD_LP_LV));
		//Verification of usPressureMin tag with Pressure Unit as -KPA
		softAssert.assertEquals(setminprsslmt,Am.conversion_of_KPA_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetminPressurelimit),Constants.COD_LP_LV));
		softAssert.assertAll();
	}
	...
	public void TC_Hydraulic_COD_LP_LV_RunUP_NorFileValue_comparision_with_UI_BAR()
			throws Exception {
		...
		softAssert.assertEquals(lwspdprssttng,Am.conversion_of_BAR_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.LowSppdPressuresetting),Constants.COD_LP_LV));
		//Verification of usPressureCalPtMax tag with Pressure Unit as -BAR
		softAssert.assertEquals(hghspdprsstng,Am.conversion_of_BAR_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.HighSppdPressuresetting),Constants.COD_LP_LV));
		//Verification of usPressureMax tag with Pressure Unit as -BAR
		softAssert.assertEquals(setmaxprsslmt,Am.conversion_of_BAR_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetmaxPressurelimit),Constants.COD_LP_LV));
		//Verification of usPressureMin tag with Pressure Unit as -BAR
		 if(setminprsslmt.contains(Am.conversion_of_BAR_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetminPressurelimit),Constants.COD_LP_LV)))
	...
	public void TC_Hydraulic_COD_LP_LV_RunUP_NorFileValue_comparision_with_UI_PSI()
			throws Exception {
		...
		softAssert.assertEquals(lwspdprssttng,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.LowSppdPressuresetting),Constants.COD_LP_LV));
		//Verification of usPressureCalPtMax tag with Pressure Unit as -PSI
		softAssert.assertEquals(hghspdprsstng,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.HighSppdPressuresetting),Constants.COD_LP_LV));
		//Verification of usPressureMax tag with Pressure Unit as -PSI
		softAssert.assertEquals(setmaxprsslmt,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetmaxPressurelimit),Constants.COD_LP_LV));
		//Verification of usPressureMin tag with Pressure Unit as -PSI
		softAssert.assertEquals(setminprsslmt,Am.conversion_of_PSI_NOR_vlaue_TO_UI_Hydraulic(xmlval.XMLParser(XMLTagConstants.SetminPressurelimit),Constants.COD_LP_LV));
		softAssert.assertAll();
	}
