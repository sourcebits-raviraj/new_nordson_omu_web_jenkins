...
public class TC_PressureHydraulic_NOR_XML_Comparsion_WAD_LV extends TC_LoginTest_DDT_001 {
	...
	public void sheetname() { 
		XLUtils.setExceltNm("NorfilePressure_Hydraulic_WAD_LV");
		XLUtils.setExcelSheetNm("Input_KPA_manualadjust");
	}
    
	@Feature("Pressure Scaling as Hydraulic with pump ratio as WAD LV and Pressure mode as Manual adjust")
	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert value in downloaded NOR file for KPA Unit for WAD LV pump ratio")
	...
	public void TC_Hydraulic_WAD_LV_Manualadjust_KPA_Pressure_Value_comparision_with_NorFile(String Min, String Max)
		...
		rsp.SelectPumpDropdown("WAD LV");
		log.info("Selected WAD LV Pump ratio for Hydraulic pressure scaling");
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(pressminVal,Constants.WAD_LV), xmlval
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(pressmaxVal,Constants.WAD_LV), xmlval
	...
	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert value in downloaded NOR file for BAR Unit for WAD LV pump ratio")
	...
	public void TC_Hydraulic_WAD_LV_Manualadjust_BAR_Pressure_Value_comparision_with_NorFile(String Min, String Max)
		...
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(pressminVal,Constants.WAD_LV), xmlval
				.XMLParser(XMLTagConstants.MinimumPressureAlertNative));
		
		//Verification of ulHighPressureAlertThresholdNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(pressmaxVal,Constants.WAD_LV), xmlval
				.XMLParser(XMLTagConstants.MaximumPressureAlertNative));
	...
	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert value in downloaded NOR file for PSI Unit for WAD LV pump ratio")
	...
	public void TC_Hydraulic_WAD_LV_Manualadjust_PSI_Pressure_Value_comparision_with_NorFile(String Min, String Max)
		...
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(pressminVal,Constants.WAD_LV), xmlval
				.XMLParser(XMLTagConstants.MinimumPressureAlertNative));
		
		//Verification of ulHighPressureAlertThresholdNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(pressmaxVal,Constants.WAD_LV), xmlval
				.XMLParser(XMLTagConstants.MaximumPressureAlertNative));
		softAssert.assertAll();
		XLUtils.setExcelSheetNm("Input_KPA_electronicadjust");
	}

	@Feature("Pressure Scaling as Hydraulic with pump ratio as WAD LV and Pressure mode as Electronic adjust for WAD LV pump ratio")
	...
	//Verification of ulPressureSetPointNative tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getPressureSetPoint(),Constants.WAD_LV), xmlval
	...
	//Verification of ulLowPressureAlertDeltaNative tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowPressureAlertThreshold(),Constants.WAD_LV),xmlval
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighPressureAlertThreshold(),Constants.WAD_LV),xmlval
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMinimumPressureSetPointRange(),Constants.WAD_LV),xmlval
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMaximumPressureSetPointRange(),Constants.WAD_LV),xmlval
	...
	@Description("Verify the All fields with value in downloaded NOR file for BAR Unit for WAD LV pump ratio")
	...
	public void TC_Hydraulic_WAD_LV_electronicadjust_BAR_Press_Value_comparision_with_NorFile(String Pressuresetpntmin,
		...
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getPressureSetPoint(),Constants.WAD_LV), xmlval
				.XMLParser(XMLTagConstants.PressureSetpointNative));
	//Verification of ulLowPressureAlertDeltaNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowPressureAlertThreshold(),Constants.WAD_LV),xmlval
				.XMLParser(XMLTagConstants.LowPressureAlertthsldelctrnicNative));
		//Verification of ulHighPressureAlertDeltaNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighPressureAlertThreshold(),Constants.WAD_LV),xmlval
				.XMLParser(XMLTagConstants.highPressureAlertthsldelctrnicNative));
		//Verification of ulPressureMinSetPointNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMinimumPressureSetPointRange(),Constants.WAD_LV),xmlval
				.XMLParser(XMLTagConstants.MinimumPressureSetpointrangeNative));
		//Verification of ulPressureMaxSetPointNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMaximumPressureSetPointRange(),Constants.WAD_LV),xmlval
				.XMLParser(XMLTagConstants.MaximumPressureSetpointrangeNative));
		softAssert.assertAll();
		XLUtils.setExcelSheetNm("Input_PSI_electronicadjust");
	}

	@Description("Verify the All fields with value in downloaded NOR file for PSI Unit for WAD LV pump ratio")
	...
	public void TC_Hydraulic_WAD_LV_electronicadjust_PSI_Press_Value_comparision_with_NorFile(String Pressuresetpntmin,
		...
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getPressureSetPoint(),Constants.WAD_LV), xmlval
				.XMLParser(XMLTagConstants.PressureSetpointNative));
	//Verification of ulLowPressureAlertDeltaNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowPressureAlertThreshold(),Constants.WAD_LV),xmlval
				.XMLParser(XMLTagConstants.LowPressureAlertthsldelctrnicNative));
		//Verification of ulHighPressureAlertDeltaNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighPressureAlertThreshold(),Constants.WAD_LV),xmlval
				.XMLParser(XMLTagConstants.highPressureAlertthsldelctrnicNative));
		//Verification of ulPressureMinSetPointNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMinimumPressureSetPointRange(),Constants.WAD_LV),xmlval
				.XMLParser(XMLTagConstants.MinimumPressureSetpointrangeNative));
		//Verification of ulPressureMaxSetPointNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMaximumPressureSetPointRange(),Constants.WAD_LV),xmlval
				.XMLParser(XMLTagConstants.MaximumPressureSetpointrangeNative));
		XLUtils.setExcelSheetNm("Input_KPA_Runup");
		softAssert.assertAll();
	}
	
@Feature("Pressure Scaling as Hydraulic with pump ratio as WAD LV and Pressure mode as Runup for WAD LV pump ratio")
	@Description("Verify the All fields with Minimum value in downloaded NOR file for KPA Unit")
	...
	public void TC_Hydraulic_WAD_LV_Runup_KPA_Press_Value_comparision_with_NorFile(String lowprssuralrtthsld,
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowSpeedPressureSetting(),Constants.WAD_LV),xmlval
				.XMLParser(XMLTagConstants.LowSppdPressuresetting));
		//Verification of usPressureCalPtMax tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighSpeedPressureSetting(),Constants.WAD_LV),xmlval
				.XMLParser(XMLTagConstants.HighSppdPressuresetting));
		//Verification of usPressureMax tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMaximumPressureLimit(),Constants.WAD_LV),xmlval
				.XMLParser(XMLTagConstants.SetmaxPressurelimit));
		//Verification of usPressureMin tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMinimumPressureLimit(),Constants.WAD_LV),xmlval
	...
	@Description("Verify the All fields with Minimum value in downloaded NOR file for BAR Unit for WAD LV pump ratio")
	...
	public void TC_Hydraulic_WAD_LV_Runup_BAR_Press_Value_comparision_with_NorFile_RunUpadjust(String lowprssuralrtthsld,
		...
		//Verification of ulLowPressureAlertDelta tag with Pressure Unit as -BAR
				...
				softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowSpeedPressureSetting(),Constants.WAD_LV),xmlval
						.XMLParser(XMLTagConstants.LowSppdPressuresetting));
				//Verification of usPressureCalPtMax tag with Pressure Unit as -BAR
				softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighSpeedPressureSetting(),Constants.WAD_LV),xmlval
						.XMLParser(XMLTagConstants.HighSppdPressuresetting));
				//Verification of usPressureMax tag with Pressure Unit as -BAR
				softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMaximumPressureLimit(),Constants.WAD_LV),xmlval
						.XMLParser(XMLTagConstants.SetmaxPressurelimit));
				//Verification of usPressureMin tag with Pressure Unit as -BAR
				softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMinimumPressureLimit(),Constants.WAD_LV),xmlval
						.XMLParser(XMLTagConstants.SetminPressurelimit));
		softAssert.assertAll();
		XLUtils.setExcelSheetNm("Input_PSI_Runup");
	}

	@Description("Verify all the fields values in downloaded NOR file for PSI Unit for WAD LV pump ratio")
	...
	public void TC_Hydraulic_WAD_LV_Runup_PSI_Press_Value_comparision_with_NorFile_RunUpadjust(String lowprssuralrtthsld,
		...
		//Verification of ulLowPressureAlertDelta tag with Pressure Unit as -PSI
				...
				softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowSpeedPressureSetting(),Constants.WAD_LV),xmlval
						.XMLParser(XMLTagConstants.LowSppdPressuresetting));
				//Verification of usPressureCalPtMax tag with Pressure Unit as -PSI
				softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighSpeedPressureSetting(),Constants.WAD_LV),xmlval
						.XMLParser(XMLTagConstants.HighSppdPressuresetting));
				//Verification of usPressureMax tag with Pressure Unit as -PSI
				softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMaximumPressureLimit(),Constants.WAD_LV),xmlval
						.XMLParser(XMLTagConstants.SetmaxPressurelimit));
				//Verification of usPressureMin tag with Pressure Unit as -PSI
				softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMinimumPressureLimit(),Constants.WAD_LV),xmlval
						.XMLParser(XMLTagConstants.SetminPressurelimit));
		softAssert.assertAll();
	...
	@Description("Verify all the Line Speed fields values in downloaded NOR file for PSI Unit with Line Speed ft/min for WAD LV pump ratio")
	...
	@Description("Verify all the Line Speed fields values in downloaded NOR file with Line Speed m/min for WAD LV pump ratio")
