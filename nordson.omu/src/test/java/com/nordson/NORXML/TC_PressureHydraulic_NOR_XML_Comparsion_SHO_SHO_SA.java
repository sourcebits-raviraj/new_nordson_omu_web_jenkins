...
public class TC_PressureHydraulic_NOR_XML_Comparsion_SHO_SHO_SA extends TC_LoginTest_DDT_001 {
	...
	public void sheetname() {
		XLUtils.setExceltNm("NorfilePressure_Hydraulic_SHO_SHO-SA");
		XLUtils.setExcelSheetNm("Input_KPA_manualadjust");
	}
    
	@Feature("Pressure Scaling as Hydraulic with pump ratio as SHO SHO-SA and Pressure mode as Manual adjust")
	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert value in downloaded NOR file for KPA Unit for SHO SHO-SA pump ratio")
	...
	public void TC_Hydraulic_SHO_SHO_SA_Manualadjust_KPA_Pressure_Value_comparision_with_NorFile(String Min, String Max)
		...
		rsp.SelectPumpDropdown("SHO SHO-SA");
		log.info("Selected SHO SHO-SA Pump ratio for Hydraulic pressure scaling");
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(pressminVal,Constants.SHO_SHO_SA), xmlval
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(pressmaxVal,Constants.SHO_SHO_SA), xmlval
	...
	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert value in downloaded NOR file for BAR Unit for SHO SHO-SA pump ratio")
	...
	public void TC_Hydraulic_SHO_SHO_SA_Manualadjust_BAR_Pressure_Value_comparision_with_NorFile(String Min, String Max)
		...
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(pressminVal,Constants.SHO_SHO_SA), xmlval
				.XMLParser(XMLTagConstants.MinimumPressureAlertNative));
		
		//Verification of ulHighPressureAlertThresholdNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(pressmaxVal,Constants.SHO_SHO_SA), xmlval
				.XMLParser(XMLTagConstants.MaximumPressureAlertNative));
	...
	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert value in downloaded NOR file for PSI Unit for SHO SHO-SA pump ratio")
	...
	public void TC_Hydraulic_SHO_SHO_SA_Manualadjust_PSI_Pressure_Value_comparision_with_NorFile(String Min, String Max)
			throws InterruptedException, IOException, SAXException {
		...
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(pressminVal,Constants.SHO_SHO_SA), xmlval
				.XMLParser(XMLTagConstants.MinimumPressureAlertNative));
		
		//Verification of ulHighPressureAlertThresholdNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(pressmaxVal,Constants.SHO_SHO_SA), xmlval
				.XMLParser(XMLTagConstants.MaximumPressureAlertNative));
		softAssert.assertAll();
		XLUtils.setExcelSheetNm("Input_KPA_electronicadjust");
	}

	@Feature("Pressure Scaling as Hydraulic with pump ratio as SHO SHO-SA and Pressure mode as Electronic adjust for SHO SHO-SA pump ratio")
	...
	public void TC_Hydraulic_SHO_SHO_SA_electronicadjust_KPA_Press_Value_comparision_with_NorFile(String Pressuresetpntmin,
	...
	//Verification of ulPressureSetPointNative tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getPressureSetPoint(),Constants.SHO_SHO_SA), xmlval
	...
	//Verification of ulLowPressureAlertDeltaNative tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowPressureAlertThreshold(),Constants.SHO_SHO_SA),xmlval
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighPressureAlertThreshold(),Constants.SHO_SHO_SA),xmlval
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMinimumPressureSetPointRange(),Constants.SHO_SHO_SA),xmlval
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMaximumPressureSetPointRange(),Constants.SHO_SHO_SA),xmlval
	...
	@Description("Verify the All fields with value in downloaded NOR file for BAR Unit for SHO SHO-SA pump ratio")
	...
	public void TC_Hydraulic_SHO_SHO_SA_electronicadjust_BAR_Press_Value_comparision_with_NorFile(String Pressuresetpntmin,
			String lowprssuralrtthsld, String highprssuralrtthsld, String minprssurstpntrng, String maxprssurstpntrng)
			throws InterruptedException, IOException, SAXException, InvalidFormatException {
		...
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getPressureSetPoint(),Constants.SHO_SHO_SA), xmlval
				.XMLParser(XMLTagConstants.PressureSetpointNative));
	//Verification of ulLowPressureAlertDeltaNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowPressureAlertThreshold(),Constants.SHO_SHO_SA),xmlval
				.XMLParser(XMLTagConstants.LowPressureAlertthsldelctrnicNative));
		//Verification of ulHighPressureAlertDeltaNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighPressureAlertThreshold(),Constants.SHO_SHO_SA),xmlval
				.XMLParser(XMLTagConstants.highPressureAlertthsldelctrnicNative));
		//Verification of ulPressureMinSetPointNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMinimumPressureSetPointRange(),Constants.SHO_SHO_SA),xmlval
				.XMLParser(XMLTagConstants.MinimumPressureSetpointrangeNative));
		//Verification of ulPressureMaxSetPointNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMaximumPressureSetPointRange(),Constants.SHO_SHO_SA),xmlval
				.XMLParser(XMLTagConstants.MaximumPressureSetpointrangeNative));
		softAssert.assertAll();
		XLUtils.setExcelSheetNm("Input_PSI_electronicadjust");
	}

	@Description("Verify the All fields with value in downloaded NOR file for PSI Unit for SHO SHO-SA pump ratio")
	...
	public void TC_Hydraulic_SHO_SHO_SA_electronicadjust_PSI_Press_Value_comparision_with_NorFile(String Pressuresetpntmin,
			String lowprssuralrtthsld, String highprssuralrtthsld, String minprssurstpntrng, String maxprssurstpntrng)
			throws InterruptedException, IOException, SAXException, InvalidFormatException {
		...
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getPressureSetPoint(),Constants.SHO_SHO_SA), xmlval
				.XMLParser(XMLTagConstants.PressureSetpointNative));
	//Verification of ulLowPressureAlertDeltaNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowPressureAlertThreshold(),Constants.SHO_SHO_SA),xmlval
				.XMLParser(XMLTagConstants.LowPressureAlertthsldelctrnicNative));
		//Verification of ulHighPressureAlertDeltaNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighPressureAlertThreshold(),Constants.SHO_SHO_SA),xmlval
				.XMLParser(XMLTagConstants.highPressureAlertthsldelctrnicNative));
		//Verification of ulPressureMinSetPointNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMinimumPressureSetPointRange(),Constants.SHO_SHO_SA),xmlval
				.XMLParser(XMLTagConstants.MinimumPressureSetpointrangeNative));
		//Verification of ulPressureMaxSetPointNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMaximumPressureSetPointRange(),Constants.SHO_SHO_SA),xmlval
				.XMLParser(XMLTagConstants.MaximumPressureSetpointrangeNative));
		XLUtils.setExcelSheetNm("Input_KPA_Runup");
		softAssert.assertAll();
	}
	
@Feature("Pressure Scaling as Hydraulic with pump ratio as SHO SHO-SA and Pressure mode as Runup for SHO SHO-SA pump ratio")
	@Description("Verify the All fields with Minimum value in downloaded NOR file for KPA Unit")
	...
	public void TC_Hydraulic_SHO_SHO_SA_Runup_KPA_Press_Value_comparision_with_NorFile(String lowprssuralrtthsld,
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowSpeedPressureSetting(),Constants.SHO_SHO_SA),xmlval
				.XMLParser(XMLTagConstants.LowSppdPressuresetting));
		//Verification of usPressureCalPtMax tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighSpeedPressureSetting(),Constants.SHO_SHO_SA),xmlval
				.XMLParser(XMLTagConstants.HighSppdPressuresetting));
		//Verification of usPressureMax tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMaximumPressureLimit(),Constants.SHO_SHO_SA),xmlval
				.XMLParser(XMLTagConstants.SetmaxPressurelimit));
		//Verification of usPressureMin tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMinimumPressureLimit(),Constants.SHO_SHO_SA),xmlval
	...
	@Description("Verify the All fields with Minimum value in downloaded NOR file for BAR Unit for SHO SHO-SA pump ratio")
	...
	public void TC_Hydraulic_SHO_SHO_SA_Runup_BAR_Press_Value_comparision_with_NorFile_RunUpadjust(String lowprssuralrtthsld,
			String highprssuralrtthsld, String lowspdprsssetting,String highspdprsssetting,
		    String setmaximumpresslmt, String setminmumpresslmt)
			throws InterruptedException, IOException, SAXException, InvalidFormatException {
		...
		//Verification of ulLowPressureAlertDelta tag with Pressure Unit as -BAR
				...
				softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowSpeedPressureSetting(),Constants.SHO_SHO_SA),xmlval
						.XMLParser(XMLTagConstants.LowSppdPressuresetting));
				//Verification of usPressureCalPtMax tag with Pressure Unit as -BAR
				softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighSpeedPressureSetting(),Constants.SHO_SHO_SA),xmlval
						.XMLParser(XMLTagConstants.HighSppdPressuresetting));
				//Verification of usPressureMax tag with Pressure Unit as -BAR
				softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMaximumPressureLimit(),Constants.SHO_SHO_SA),xmlval
						.XMLParser(XMLTagConstants.SetmaxPressurelimit));
				//Verification of usPressureMin tag with Pressure Unit as -BAR
				softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMinimumPressureLimit(),Constants.SHO_SHO_SA),xmlval
						.XMLParser(XMLTagConstants.SetminPressurelimit));
		softAssert.assertAll();
		XLUtils.setExcelSheetNm("Input_PSI_Runup");
	}

	@Description("Verify all the fields values in downloaded NOR file for PSI Unit for SHO SHO-SA pump ratio")
	...
	public void TC_Hydraulic_SHO_SHO_SA_Runup_PSI_Press_Value_comparision_with_NorFile_RunUpadjust(String lowprssuralrtthsld,
			String highprssuralrtthsld, String lowspdprsssetting,String highspdprsssetting,
		    String setmaximumpresslmt, String setminmumpresslmt)
			throws InterruptedException, IOException, SAXException, InvalidFormatException {
		...
		//Verification of ulLowPressureAlertDelta tag with Pressure Unit as -PSI
				...
				softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowSpeedPressureSetting(),Constants.SHO_SHO_SA),xmlval
						.XMLParser(XMLTagConstants.LowSppdPressuresetting));
				//Verification of usPressureCalPtMax tag with Pressure Unit as -PSI
				softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighSpeedPressureSetting(),Constants.SHO_SHO_SA),xmlval
						.XMLParser(XMLTagConstants.HighSppdPressuresetting));
				//Verification of usPressureMax tag with Pressure Unit as -PSI
				softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMaximumPressureLimit(),Constants.SHO_SHO_SA),xmlval
						.XMLParser(XMLTagConstants.SetmaxPressurelimit));
				//Verification of usPressureMin tag with Pressure Unit as -PSI
				softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMinimumPressureLimit(),Constants.SHO_SHO_SA),xmlval
						.XMLParser(XMLTagConstants.SetminPressurelimit));
		softAssert.assertAll();
	...
	@Description("Verify all the Line Speed fields values in downloaded NOR file for PSI Unit with Line Speed ft/min for SHO SHO-SA pump ratio")
	...
	public void TC_Hydraulic_SHO_SHO_SA_Runup_LineSpeedftpermin_Press_Value_comparision_with_NorFile( String lowlnspdsetting,String highlnspdsettings,String fullscalelnspd)
			throws InterruptedException, IOException, SAXException, InvalidFormatException {
	...
	@Description("Verify all the Line Speed fields values in downloaded NOR file with Line Speed m/min for SHO SHO-SA pump ratio")
	...
	public void TC_Hydraulic_SHO_SHO_SA_Runup_LineSpeedmpermin_Press_Value_comparision_with_NorFile( String lowlnspdsetting,
