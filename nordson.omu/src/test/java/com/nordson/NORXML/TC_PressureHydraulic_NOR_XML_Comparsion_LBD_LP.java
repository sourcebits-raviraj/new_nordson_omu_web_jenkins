...
public class TC_PressureHydraulic_NOR_XML_Comparsion_LBD_LP extends TC_LoginTest_DDT_001 {
	...
	public void sheetname() { 
		XLUtils.setExceltNm("NorfilePressure_Hydraulic_LBD_LP");
		XLUtils.setExcelSheetNm("Input_KPA_manualadjust");
	}
    
	@Feature("Pressure Scaling as Hydraulic with pump ratio as LBD_LP and Pressure mode as Manual adjust")
	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert value in downloaded NOR file for KPA Unit for LBD_LP pump ratio")
	...
	public void TC_Hydraulic_LBD_LP_Manualadjust_KPA_Pressure_Value_comparision_with_NorFile(String Min, String Max)
			throws Exception {
		...
		log.info("Selected LBD_LP Pump ratio for Hydraulic pressure scaling");
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(pressminVal,Constants.LBD_LP), xmlval
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(pressmaxVal,Constants.LBD_LP), xmlval
	...
	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert value in downloaded NOR file for BAR Unit for LBD_LP pump ratio")
	...
	public void TC_Hydraulic_LBD_LP_Manualadjust_BAR_Pressure_Value_comparision_with_NorFile(String Min, String Max)
			throws Exception {
		...
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(pressminVal,Constants.LBD_LP), xmlval
				.XMLParser(XMLTagConstants.MinimumPressureAlertNative));
		
		//Verification of ulHighPressureAlertThresholdNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(pressmaxVal,Constants.LBD_LP), xmlval
				.XMLParser(XMLTagConstants.MaximumPressureAlertNative));
	...
	@Description("Verify the Minimum Pressure Alert and Maximum Pressure Alert value in downloaded NOR file for PSI Unit for LBD_LP pump ratio")
	...
	public void TC_Hydraulic_LBD_LP_Manualadjust_PSI_Pressure_Value_comparision_with_NorFile(String Min, String Max)
			throws Exception {
		...
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(pressminVal,Constants.LBD_LP), xmlval
				.XMLParser(XMLTagConstants.MinimumPressureAlertNative));
		
		//Verification of ulHighPressureAlertThresholdNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(pressmaxVal,Constants.LBD_LP), xmlval
				.XMLParser(XMLTagConstants.MaximumPressureAlertNative));
		softAssert.assertAll();
		XLUtils.setExcelSheetNm("Input_KPA_electronicadjust");
	}

	@Feature("Pressure Scaling as Hydraulic with pump ratio as LBD_LP and Pressure mode as Electronic adjust for LBD_LP pump ratio")
	...
	public void TC_Hydraulic_LBD_LP_electronicadjust_KPA_Press_Value_comparision_with_NorFile(String Pressuresetpntmin,
	...
	//Verification of ulPressureSetPointNative tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getPressureSetPoint(),Constants.LBD_LP), xmlval
	...
	//Verification of ulLowPressureAlertDeltaNative tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowPressureAlertThreshold(),Constants.LBD_LP),xmlval
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighPressureAlertThreshold(),Constants.LBD_LP),xmlval
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMinimumPressureSetPointRange(),Constants.LBD_LP),xmlval
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMaximumPressureSetPointRange(),Constants.LBD_LP),xmlval
	...
	@Description("Verify the All fields with value in downloaded NOR file for BAR Unit for LBD_LP pump ratio")
	...
	public void TC_Hydraulic_LBD_LP_electronicadjust_BAR_Press_Value_comparision_with_NorFile(String Pressuresetpntmin,
			String lowprssuralrtthsld, String highprssuralrtthsld, String minprssurstpntrng, String maxprssurstpntrng)
			throws Exception, InvalidFormatException {
		...
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getPressureSetPoint(),Constants.LBD_LP), xmlval
				.XMLParser(XMLTagConstants.PressureSetpointNative));
	//Verification of ulLowPressureAlertDeltaNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowPressureAlertThreshold(),Constants.LBD_LP),xmlval
				.XMLParser(XMLTagConstants.LowPressureAlertthsldelctrnicNative));
		//Verification of ulHighPressureAlertDeltaNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighPressureAlertThreshold(),Constants.LBD_LP),xmlval
				.XMLParser(XMLTagConstants.highPressureAlertthsldelctrnicNative));
		//Verification of ulPressureMinSetPointNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMinimumPressureSetPointRange(),Constants.LBD_LP),xmlval
				.XMLParser(XMLTagConstants.MinimumPressureSetpointrangeNative));
		//Verification of ulPressureMaxSetPointNative tag with Pressure Unit as -BAR
		softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMaximumPressureSetPointRange(),Constants.LBD_LP),xmlval
				.XMLParser(XMLTagConstants.MaximumPressureSetpointrangeNative));
		softAssert.assertAll();
		XLUtils.setExcelSheetNm("Input_PSI_electronicadjust");
	}

	@Description("Verify the All fields with value in downloaded NOR file for PSI Unit for LBD_LP pump ratio")
	...
	public void TC_Hydraulic_LBD_LP_electronicadjust_PSI_Press_Value_comparision_with_NorFile(String Pressuresetpntmin,
			String lowprssuralrtthsld, String highprssuralrtthsld, String minprssurstpntrng, String maxprssurstpntrng)
			throws Exception, InvalidFormatException {
		...
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getPressureSetPoint(),Constants.LBD_LP), xmlval
				.XMLParser(XMLTagConstants.PressureSetpointNative));
	//Verification of ulLowPressureAlertDeltaNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowPressureAlertThreshold(),Constants.LBD_LP),xmlval
				.XMLParser(XMLTagConstants.LowPressureAlertthsldelctrnicNative));
		//Verification of ulHighPressureAlertDeltaNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighPressureAlertThreshold(),Constants.LBD_LP),xmlval
				.XMLParser(XMLTagConstants.highPressureAlertthsldelctrnicNative));
		//Verification of ulPressureMinSetPointNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMinimumPressureSetPointRange(),Constants.LBD_LP),xmlval
				.XMLParser(XMLTagConstants.MinimumPressureSetpointrangeNative));
		//Verification of ulPressureMaxSetPointNative tag with Pressure Unit as -PSI
		softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getMaximumPressureSetPointRange(),Constants.LBD_LP),xmlval
				.XMLParser(XMLTagConstants.MaximumPressureSetpointrangeNative));
		XLUtils.setExcelSheetNm("Input_KPA_Runup");
		softAssert.assertAll();
	}
	
@Feature("Pressure Scaling as Hydraulic with pump ratio as LBD_LP and Pressure mode as Runup for LBD_LP pump ratio")
	@Description("Verify the All fields with Minimum value in downloaded NOR file for KPA Unit")
	...
	public void TC_Hydraulic_LBD_LP_Runup_KPA_Press_Value_comparision_with_NorFile(String lowprssuralrtthsld,
		...
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowSpeedPressureSetting(),Constants.LBD_LP),xmlval
				.XMLParser(XMLTagConstants.LowSppdPressuresetting));
		//Verification of usPressureCalPtMax tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighSpeedPressureSetting(),Constants.LBD_LP),xmlval
				.XMLParser(XMLTagConstants.HighSppdPressuresetting));
		//Verification of usPressureMax tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMaximumPressureLimit(),Constants.LBD_LP),xmlval
				.XMLParser(XMLTagConstants.SetmaxPressurelimit));
		//Verification of usPressureMin tag with Pressure Unit as -KPA
		softAssert.assertEquals(Am.conversion_of_KPA_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMinimumPressureLimit(),Constants.LBD_LP),xmlval
	...
	@Description("Verify the All fields with Minimum value in downloaded NOR file for BAR Unit for LBD_LP pump ratio")
	...
	public void TC_Hydraulic_LBD_LP_Runup_BAR_Press_Value_comparision_with_NorFile_RunUpadjust(String lowprssuralrtthsld,
			String highprssuralrtthsld, String lowspdprsssetting,String highspdprsssetting,
		    String setmaximumpresslmt, String setminmumpresslmt)
			throws Exception, InvalidFormatException {
		...
		//Verification of ulLowPressureAlertDelta tag with Pressure Unit as -BAR
				...
				softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowSpeedPressureSetting(),Constants.LBD_LP),xmlval
						.XMLParser(XMLTagConstants.LowSppdPressuresetting));
				//Verification of usPressureCalPtMax tag with Pressure Unit as -BAR
				softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighSpeedPressureSetting(),Constants.LBD_LP),xmlval
						.XMLParser(XMLTagConstants.HighSppdPressuresetting));
				//Verification of usPressureMax tag with Pressure Unit as -BAR
				softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMaximumPressureLimit(),Constants.LBD_LP),xmlval
						.XMLParser(XMLTagConstants.SetmaxPressurelimit));
				//Verification of usPressureMin tag with Pressure Unit as -BAR
				softAssert.assertEquals(Am.conversion_of_BAR_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMinimumPressureLimit(),Constants.LBD_LP),xmlval
						.XMLParser(XMLTagConstants.SetminPressurelimit));
		softAssert.assertAll();
		XLUtils.setExcelSheetNm("Input_PSI_Runup");
	}

	@Description("Verify all the fields values in downloaded NOR file for PSI Unit for LBD_LP pump ratio")
	...
	public void TC_Hydraulic_LBD_LP_Runup_PSI_Press_Value_comparision_with_NorFile_RunUpadjust(String lowprssuralrtthsld,
			String highprssuralrtthsld, String lowspdprsssetting,String highspdprsssetting,
		    String setmaximumpresslmt, String setminmumpresslmt)
			throws Exception, InvalidFormatException {
		...
		//Verification of ulLowPressureAlertDelta tag with Pressure Unit as -PSI
				...
				softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getLowSpeedPressureSetting(),Constants.LBD_LP),xmlval
						.XMLParser(XMLTagConstants.LowSppdPressuresetting));
				//Verification of usPressureCalPtMax tag with Pressure Unit as -PSI
				softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getHighSpeedPressureSetting(),Constants.LBD_LP),xmlval
						.XMLParser(XMLTagConstants.HighSppdPressuresetting));
				//Verification of usPressureMax tag with Pressure Unit as -PSI
				softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMaximumPressureLimit(),Constants.LBD_LP),xmlval
						.XMLParser(XMLTagConstants.SetmaxPressurelimit));
				//Verification of usPressureMin tag with Pressure Unit as -PSI
				softAssert.assertEquals(Am.conversion_of_PSI_App_vlaue_for_Norfile_comparision_Hydraulic(rsp.getSetMinimumPressureLimit(),Constants.LBD_LP),xmlval
						.XMLParser(XMLTagConstants.SetminPressurelimit));
		softAssert.assertAll();
	...
	@Description("Verify all the Line Speed fields values in downloaded NOR file for PSI Unit with Line Speed ft/min for LBD_LP pump ratio")
	...
	public void TC_Hydraulic_LBD_LP_Runup_LineSpeedftpermin_Press_Value_comparision_with_NorFile( String lowlnspdsetting,String highlnspdsettings,String fullscalelnspd)
			throws Exception, InvalidFormatException {
	...
	@Description("Verify all the Line Speed fields values in downloaded NOR file with Line Speed m/min for LBD_LP pump ratio")
	@Test(priority = 11, dataProvider = "Presure_for_norfile_RunUp_LineSpeed", dataProviderClass = com.nordson.utilities.XLUtils.class)
	public void TC_Hydraulic_LBD_LP_Runup_LineSpeedmpermin_Press_Value_comparision_with_NorFile( String lowlnspdsetting,
